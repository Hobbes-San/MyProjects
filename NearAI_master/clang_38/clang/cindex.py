...
import clang_38.clang.enumerations
...
class TranslationUnit(ClangObject):
    ...
    def from_source(cls, filename, args=None, unsaved_files=None, options=0,
        ...
        ptr = conf.lib.clang_parseTranslationUnit(index, filename, args_array, len(args), unsaved_array, len(unsaved_files), options)
...
def register_enumerations():
    for name, value in clang_38.clang.enumerations.TokenKinds:
        TokenKind.register(value, name)

print(CursorKind.get_all_kinds())

conf = Config()
Config.set_library_path("/usr/lib/llvm-3.8/lib")
#conf.set_library_file("/usr/lib/x86_64-linux-gnu/libstdc++.so.6")#
